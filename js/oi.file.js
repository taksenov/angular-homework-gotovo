...
angular.module('oi.file', [])
  ...
  .value('oiFileConfig', {
    ...
    fieldName:     'filesFactory',         //Key in $_FILES array
      ...
      link: function (scope, element, attrs) {
        ...
        element
          ...
          .bind('dragover', function(e) {
            ...
            dataTransfer && dataTransfer.types && dataTransfer.types.indexOf('filesFactory') >= 0 ? element.addClass(opts.fileClass) : element.addClass(opts.notFileClass);
          })
